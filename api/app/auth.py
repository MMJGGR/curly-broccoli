...
def get_current_user_profile(
    ...
    return ProfileResponse(
        ...
        profile={
            ...
            "estimated_annual_taxes": profile.estimated_annual_taxes,
            "tax_deductions": profile.tax_deductions,
            "life_insurance_coverage": profile.life_insurance_coverage,
            "health_insurance_type": profile.health_insurance_type,
            "insurance_beneficiaries": profile.insurance_beneficiaries,
            "target_retirement_age": profile.target_retirement_age,
            "expected_retirement_expenses": profile.expected_retirement_expenses,
            "social_security_estimated": profile.social_security_estimated,
            "retirement_accounts": profile.retirement_accounts,
