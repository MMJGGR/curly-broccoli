...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('marital_status', sa.Enum('Single', 'Married', 'Divorced', 'Widowed', name='marital_status')),
        sa.Column('employment_status', sa.Enum('Employed', 'Self-employed', 'Unemployed', 'Student', 'Retired', name='employment_status'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('relation_type', sa.Enum('Spouse', 'Child', 'Parent', 'Other', name='relationship'), nullable=False),
